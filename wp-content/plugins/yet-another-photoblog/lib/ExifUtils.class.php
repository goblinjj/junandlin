<?php
	...
	/*	Class ExifUtil
		This class provides some higher level methods around phpExifRW
	...
	*/
	...
	class ExifUtils {
		 ...
		 * @return array
		 **/
		public static function getExifData($yapbImage, $flagUnfiltered=false) {
		 ...
		 * @return array
		 **/
		public static function filterExifData($exifData) {
		 ...
		 * @return array
		 */
		public static function getLearnedTagnames() {
		 ...
		 */
		public static function learnTagnames($exifArray) {
		 ...
		 * @return array
		 */
		public static function getTagnamesFilter() {
